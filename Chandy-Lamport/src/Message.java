...
enum MessageType {
	string, integer, marker, forward, flood, flood_ack, map, end, converge_cast
};
...
public class Message implements Serializable {
	...
	public ArrayList<Integer> piggyback;
	...
	public Message(String msg, MessageType t) {
		msgType = t;
		message = msg;
	}

	public Message(LocalState l, MessageType t) {
		msgType = t;
		ls = l;
	}

	public Message(int msg, MessageType t, ArrayList<Integer> clock) {
		msgType = t;
		message = Integer.toString(msg);
		piggyback = clock;
	}

	public Message(String msg, MessageType t, ArrayList<Integer> clock) {
		msgType = t;
		message = msg;
		piggyback = clock;
	}
